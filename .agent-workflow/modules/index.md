...
|--------|------|:----:|---------|:----:|:----:|:--------:|--------|----------|
| desktop-surface | desktop surface（Electron 桌面外壳，无后台服务） | MODULE | `dsh --profile desktop` 起 Electron 原生窗口加载 DSH web（无本地 HTTP 监听，IPC 桥接），零定制复用；支持打包 Electron 运行时发 Release | 🟢 已完成 | 🟢 有效 | 2026-08-15 | desktop,electron,surface,web,launcher,release,package,ipc | [desktop-surface.md](./desktop-surface.md) |
